  ...
  public Drivetrain(RobotConfig config) {
    ...
    AutoBuilder.configureHolonomic(
      ...
      new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
        new PIDConstants(0.75, 0, 0), // Translation PID constants
        new PIDConstants(0.2, 0, 0), // Rotation PID constants        0.7
        m_config.Drivetrain.MaxSpeedMetersPerSecond, // Max module speed, in m/s
        m_config.Drivetrain.DriveBaseRadius, // Drive base radius in meters. Distance from robot center to furthest module.
