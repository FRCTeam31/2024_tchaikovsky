...
public class CTREConverter {
     ...
     */
    public static Rotation2d falconToRotation(double positionCounts, double gearRatio) {
        return Rotation2d.fromDegrees(falconToDegrees(positionCounts, gearRatio));
    }
     ...
     * @return Falcon Position Counts
     */
    public static double rotationToFalcon(Rotation2d rotation, double gearRatio) {
        return degreesToFalcon(rotation.getDegrees(), gearRatio);
    }
